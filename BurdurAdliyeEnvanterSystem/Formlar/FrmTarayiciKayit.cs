...
{
    public partial class FrmTarayiciKayit : Form
    {
        public FrmTarayiciKayit()
        {
            InitializeComponent();
        }
        ...
        void Listeleme()
        {
            var deger = from x in db.TBLTARAYICILAR
                        select new
                        {
                            x.ID,
        ...
        private void FrmTarayiciKayit_Load(object sender, EventArgs e)
        {
            Listeleme();
            MarkaEkle();
        }
        ...
        {
            TBLTARAYICILAR t = new TBLTARAYICILAR();
            ...
            db.TBLTARAYICILAR.Add(t);
            db.SaveChanges();
            MessageBox.Show("Tarayıcı başarıyla kaydedildi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Listeleme();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            var deger = db.TBLTARAYICILAR.Find(id);
            ...
            db.SaveChanges();
            MessageBox.Show("Tarayıcı kaydı güncellendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Listeleme();
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            deger.ZIMMET = false;
            db.SaveChanges();
            MessageBox.Show("Tarayıcı pasif duruma alındı", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            Listeleme();
        }
