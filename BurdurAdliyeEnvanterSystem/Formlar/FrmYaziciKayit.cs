...
{
    public partial class FrmYaziciKayit : Form
    {
        public FrmYaziciKayit()
        {
            InitializeComponent();
        }
        ...
        void Listeleme()
        {
            var deger = from x in db.TBLYAZICILAR
                        select new
                        {
                            x.ID,
        ...
        private void FrmYaziciKayit_Load(object sender, EventArgs e)
        {
            Listeleme();
            MarkaEkle();
        }
        ...
        {
            TBLYAZICILAR t = new TBLYAZICILAR();
            ...
            db.TBLYAZICILAR.Add(t);
            db.SaveChanges();
            MessageBox.Show("Yazıcı başarıyla kaydedildi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Listeleme();
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            var deger = db.TBLYAZICILAR.Find(id);
            ...
            db.SaveChanges();
            MessageBox.Show("Yazıcı kaydı güncellendi", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Listeleme();
        }
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            deger.ZIMMET = false;
            db.SaveChanges();
            MessageBox.Show("Yazıcı pasif duruma alındı", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            Listeleme();
        }
